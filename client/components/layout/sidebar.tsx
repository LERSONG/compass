...
import {Orchestration, orchestrationRoute, podsURL} from "../+orchestration";
import {EnhancedOrchestration, enhancedorchestrationRoute, stonesURL} from "../+enhancedorchestration";
      ...
      <SidebarContext.Provider value={{ pinned: isPinned }}>
        <div className={cssNames("Sidebar flex column", className, { pinned: isPinned })}>
          ...
          <div className="sidebar-nav flex column box grow-fixed">
            ...
            />
            <SidebarNavItem
                id="enhancedorchestration"
                url={stonesURL({ query })}
                routePath={enhancedorchestrationRoute.path}
                subMenus={EnhancedOrchestration.tabRoutes}
                text={<Trans>EnhancedOrchestration</Trans>}
                icon={<Icon svg="workloads" />}
            />
            <SidebarNavItem
                id="orchestration"
                url={podsURL({ query })}
                routePath={orchestrationRoute.path}
                subMenus={Orchestration.tabRoutes}
                text={<Trans>Orchestration</Trans>}
                icon={<Icon svg="workloads" />}
            />
            <SidebarNavItem
                id="job"
