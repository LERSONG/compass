...
import {UserManagement, usersManagementRoute} from "./+user-management";
...
import {eventRoute, Events} from "./+events";
...
import {PodLogsDialog} from "./+orchestration-pods/pod-logs-dialog";
import {DeploymentScaleDialog} from "./+orchestration-deployments/deployment-scale-dialog";
import {CustomResources} from "./+custom-resources/custom-resources";
import {crdRoute} from "./+custom-resources";
import {Orchestration, orchestrationRoute} from "./+orchestration";
import {EnhancedOrchestration, enhancedorchestrationRoute} from "./+enhancedorchestration";
import {Job, jobRoute} from "./+job";
          ...
          <Router history={browserHistory}>
            <ErrorBoundary>
              <Switch>
                ...
                <Route component={EnhancedOrchestration} {...enhancedorchestrationRoute} />
                <Route component={Orchestration} {...orchestrationRoute} />
                <Route component={Job} {...jobRoute} />
